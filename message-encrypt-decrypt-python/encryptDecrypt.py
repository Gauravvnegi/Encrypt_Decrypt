...
def Result():
    ...
    if (i==1):
        ...
        messagebox.showinfo('Gaurav Negi', 'Please Choose one of Encryption or Decrption. Try again.')
...
wn.title("Encrypt and Decrypt Message by Gaurav Negi")
